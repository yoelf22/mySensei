...
<main>
  ...
  <form id="f">
    ...
    <label>Any particular angle or goal? <span class="hint">(optional)</span><input type="text" name="angle" placeholder="e.g. master a concept, prepare for an exam, or deepen a skill"></label>
    ...
    <label>Your education level <span class="hint">(sets how the lessons are written — separate from how advanced the content gets)</span></label>
