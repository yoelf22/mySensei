...
export function renderOnboardHtml({ webhookUrl }) {
...
<main>
  ...
  <form id="f">
    ...
    <label>Language</label><input type="text" name="language" value="English">
...
(function(){
  ...
  var LANG = {english:"en",hebrew:"he",spanish:"es",french:"fr",german:"de",arabic:"ar",italian:"it",portuguese:"pt",russian:"ru",japanese:"ja",chinese:"zh",dutch:"nl"};
  ...
  f.addEventListener("submit", function(e){
    ...
    var lang = (d.get("language")||"English").trim();
    var payload = {
      type:"onboard",
      subject:(d.get("subject")||"").trim(),
      angle:(d.get("angle")||"").trim(),
      language:lang,
      languageCode: LANG[lang.toLowerCase()] || lang.slice(0,2).toLowerCase(),
