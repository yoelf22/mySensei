...
const LABELS = {
  ...
  he: { learnMore: "למדו עוד", quizTitle: "בדיקה מהירה", submit: "שלח מבדק", passed: "הבנת. השיעור הבא ימשיך הלאה.", failed: "לא לגמרי — השיעור הבא יחזור על זה בחומר אחר.", answerAll: "נא לענות על כל השאלות.", sent: "התוצאה נשלחה.", offline: "לא התקבלה גישה לשרת — בדקו את החיבור ושלחו שוב.", correctAnswer: "תשובה נכונה:" },
};
